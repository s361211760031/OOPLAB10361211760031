...
public class EmployeeDAOImpl implements employeeDAO {
    ...
    public static final String ADD_EMP = "insert into Employee" +
            "(empID, Name,Postion,Salary) values (?,?,?,?)";
    public static final String UPDATE_EMP = "update Employee set" +
            " Name = ?, Postion = ?, Salary = ? where empID = ?";
    ...
    public static EmployeeDAOImpl getInstance() { return instant; }
    ...
    public void addEmp(Employee newEmp) {
        try {
            ...
            System.out.println("Already daa you data to database.");
            //close connection
            ps.close();
            conn.close();
